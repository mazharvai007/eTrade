...
<div class="off-canvas position-left reveal-for-large nav" id="offCanvas" data-off-canvas>
    ...
    <ul class="vertical menu">
        ...
        <li><a href="/admin/logout"><i class="fa fa-sign-out-alt fa-fw" aria-hidden="true"></i> Logout</a></li>
    </ul>
</div>
<!-- End Sidebar --><?php /**PATH /home/mazhar/www/practice/php/eTrade/resources/views/includes/admin-sidebar.blade.php ENDPATH**/ ?>